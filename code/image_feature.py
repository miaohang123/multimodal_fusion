...
class ImageFeature(object):
    def __init__(self, datapath):
        self.image_path_list = data_iterator.DataIterator(datapath, 'model').image_path_list
        self.model()
...
if __name__ == '__main__':
    image_feature_object = ImageFeature(datapath='../reddit/valid_data_path/multimodal.train.txt')
